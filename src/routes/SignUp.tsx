...
import { Form, FormContainer, Image, ImageContainer, Input, InputTitle, LoginFormContainer, Option, Select, SignInError, Switcher, Title, Wrapper } from "../components/auth-compnents";
